...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\namesection{David}{Sinden}{ \urlstyle{same}\href{http://djps.github.io}{djps.github.io}| \href{http://fb.co/dd}{fb.co/dd}\\
\href{mailto:deedy@fb.com}{deedy@fb.com} | 607.379.5733 | \href{mailto:david.sinden@gmail.com}{david.sinden@gmail.com}
}
...
\descript{PhD}
\location{Sept 2008 | London, UK}
\sectionsep

\subsection{University of Bath}
\descript{MSc Applied Maths}
\location{Oct 2004 | Bath, UK}
...
\subsection{Imperial College Londen}
\location{May 2003| London, UK}
