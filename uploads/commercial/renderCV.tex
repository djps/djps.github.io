...
\begin{document}
    ...
    \begin{header}
        ...
        \normalsize
        \mbox{{\footnotesize\faMapMarker*}\hspace*{0.13cm}Bremen, Germany}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
    ...
    \section{Education}
        \begin{threecolentry}{\textbf{PhD}}{Sept 2004 – June 2007}
            \textbf{University College London}, Dynamical Systems
            \begin{highlights}
                \item Thesis Title 
            \end{highlights}
        \end{threecolentry}

        \begin{threecolentry}{\textbf{MSc}}{Sept 2003 – Sept 2004}
            \textbf{University of Bath}, Modern Applications of Mathematics
        \end{threecolentry}
        
        \begin{threecolentry}{\textbf{BSc}}{Sept 2000 – Sept 2003}
            \textbf{Imperial College London}, Mathematics with Applied Mathematics/Theoretical Physics
        \end{threecolentry}
    ...
    \section{Experience}
        ...
        \begin{twocolentry}{Teddington, UK\\2014--2019}
            \textbf{National Physical Laboratory}, Senior Research Scientist
            \begin{highlights}
\item Established measurement-based simulation for nonlinear propagation through complex media for accurate predictions, included in IEC standard. 
        ...
        \begin{twocolentry}{Sutton, United Kingdom\\2011--2014}
            \textbf{Institute of Cancer Research/The Royal Marsden Hospital}, Post-Doctoral Research Associate - Focused Ultrasound Group
            \begin{highlights}
\item Development of ultrasound-guided high-intensity focused ultrasound \newline{}treatment planning system with a multi-element phased-array.  
        ...
        \end{twocolentry}
        \vspace{0.2 cm}
        \begin{twocolentry}{London, United Kingdom\\2018--2011}
            \textbf{Post-Doctoral Research Associate} - Dept. Mechanical Engineering
            \begin{highlights}
