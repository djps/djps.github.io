...
\hypersetup{%
  pdftitle={David Sinden - Computational Modeling Scientist},
  pdfauthor={David Sinden},
  pdfsubject={Cover Letter},
  pdfkeywords={Cover Letter, Job Application, Research Scientist, Computational Modeling Scientist}
}
\thispagestyle{fancy}
%
\recipient{GSO e. V.}{Friedrichstrasse 60\\
10117 Berlin}

\date{October 1, 2025}

\opening{Letter of motivation}
%
\makemyletterhead 

\makecvfooter{October, 2025}{David Sinden~~~·~~~Motivation Letter}{\thepage~of~\pageref{LastPage}}
%
...
\textcolor{lightblue}{\underline{\textbf{Re: \enquote{Computational Modeling Scientist} }}}
\end{minipage}
%\vspace{1\baselineskip}
\vfill

Not all members of the final selection committee are from your field, but they are interested to learn more about you as a person. They will evaluate your letter of motivation based on these questions: 

* What are your personal and professional development and career goals?  
* What kind of support do you need/desire? 
* What drives you?  
* What is important to you in scientific collaboration?  
* How do you ensure that research and collaboration work well?  
* What do you contribute that creates and adds value to science (and to the group of fellows)? 
