...
\renewcommand*{\sectionstyle}[1]{{\fontsize{12pt}{1em}\bodyfont\bfseries\color{color1} #1}}
...
\makecvfooter{October, 2025}{David Sinden~~~$\cdot$~~~Research Statement}{\thepage\ ~of~ \pageref{LastPage}}
...
%\let\addcontentsline\@gobblethree
  % now call your normal bibliography commands
