...
\begin{center}
{\Huge\color{FhGreen}Enabling targeted drug delivery through the blood brain barrier}
\end{center}
...
& \textbf{\Large David Sinden, PhD}\\
& \texttt{david.sinden{@}mevis.fraunhofer.de}\vspace{0.8cm}\\
%Institute : 
Fraunhofer Institute for Digital Medicine MEVIS & Microbubbles \\
Max-von-Laue-Strasse 2                          & Drug Delivery \\
28359 Bremen                                    & Control Theory %\\[2cm]
%& Submitted 2025
\end{tabularx}
...
% Outline the time frame for your project, including preliminary work, intermediate and final project goals. What are the key milestones of the project during the funding period?
