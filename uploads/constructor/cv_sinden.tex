...
\begin{cventries}
%
\cventry{Senior Research Scientist -- Modelling \& Simulation -- Prof. Tobias Preusser}{Fraunhofer Institute for Digital Medicine MEVIS}{Bremen, DE}{2019 - present}{%
\begin{cvitems}
...
\end{cvitems}}
%
\cventry{Senior Research Scientist -- Ultrasound \& Underwater Acoustics -- Prof. Bajram Zeqiri}{National Physical Laboratory}{Teddington, UK}{2014 - 2019}{\begin{cvitems}
...
\end{cvitems}}
%
\cventry{Post-doctoral Research Associate -- Therapeutic Ultrasound Group -- Prof. Gail ter Haar}{Institute of Cancer Research}{Sutton, UK}{2011 - 2014}{\begin{cvitems}
...
\end{cvitems}}
%
\cventry{Post-doctoral Research Associate -- Department of Mechanical Engineering -- Prof. Nader Safari}{University College London}{London, UK}{2008 - 2011}{\begin{cvitems}
...
%
\begin{cventries}
\cventry{Dynamical Systems}{PhD -- University College London, UK}{}{2004 - 2008}{%
\begin{cvitems}% 
...
\item Examiners: Prof Gabriel Lord, Prof Darryl Holm.
\end{cvitems}}%\vspace{-4.0mm}
%
\cventry{Modern Applications of Mathematics}{MSc -- University of Bath, UK}{}{2003 - 2004}{}\vspace{-4.0mm}
%    
\cventry{Maths with Applied Mathematics \& Theoretical Physics  -- 2.1}{BSc -- Imperial College London, UK}{}{2000 - 2003}{}\vspace{-4.0mm}
\end{cventries}
%
...
\begin{cventries}
%
\cventry{Adjunct Lecturer}{Department of Mobility, Jacobs University Bremen}{Bremen, Germany}{2022 - }{%
\begin{cvitems}
\item Numerical Methods [CTMS-MATH-13]: second year course for engineering and mathematics students.
...
For students on prestigious \enquote{Bolashak} scholarship and in newly-established partner campus with UCL at Nazarbayez University\newline
%\newline
\begin{itemize}[leftmargin=2ex, nosep, noitemsep] %, after=0pt]
%\setlength{\parskip}{0pt}
\item Involved in construction of mathematics modules of new courses in mechanical and civil engineering degrees, design of syllabus and preparation of course notes
\begin{itemize}
...
\begin{cvitems}
\item Member of Fraunhofer MEVIS diversity and inclusion task force (2021-present)
\item Member of ICR's Athena Swan (accreditation scheme for advancement of gender equality, representation, progression in higher eduction) taskforce (2012)
\end{cvitems}}
%
...
\begin{cvitems}
\item M.Sc. funded by EPSRC scholarship (2003--4), EPSRC funding for Ph.D. (2004--7) and post-doctoral work (2008--2011, 2011--2013, 2014)
\end{cvitems}}

\cventry{}{Professional Affiliations}{}{}{\vspace*{-0.5cm}
\begin{cvitems}
\item Member of the Society for Industrial and Applied Mathematics member (2004--present) and member of the Institute of Physics (2008--present), associate member Institute of Mathematics and its Applications (2016--present)
\end{cvitems}}

\cventry{}{Service}{}{}{\vspace*{-0.5cm}
\begin{cvitems}
\item Reviewer for a number of journals (Int.~J.~Hyperthermia $\cdot$ Ultrasonics $\cdot$ Ultrasound Med. \& Biol. $\cdot$ Med.~Phys. $\cdot$ Comp.~Meth.~Prog.~Biomed. $\cdot$ J. Open Source Softw.), as well as funding agencies (ANR).
\item Mentor to junior staff at NPL (2015--2019)
\item Developer in open-source scientific code: \texttt{k-wave-python}
\end{cvitems}}
...
\cvskillentry*{Methods:}{3}{Software development}{8}{Version control, continuous integration, build systems, testing, documentation, virtualization}
\cvskillentry*{Languages:}{-1}{English}{}{Native}\\[-0.25cm]
\cvskillentry*{}{-1}{German}{}{B2}
%\cvskillentry*{Languages:}{-1}{\centering English\newline German}{}{Native\newline B2}
%\cvskillentry[-12pt]{}{-1}{German}{}{Intermediate (B2)}
...
%
\cvhonorStretch[1.0]%
{Analysis for Innovators (A4I), with Deltex Medical Devices Ltd \newline}%
{Optimizing Oesophageal Doppler Transducers}%
{\textsterling{}26,500}%
{2018}
%
\cvhonorStretch[1.0]%
{Industrial Challenge Strategy Fund, Wave 1, Metrology for Medical Imaging, with Huntleigh Diagnostics Ltd \newline}%
