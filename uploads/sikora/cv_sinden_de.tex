...
\documentclass[german, print]{cv-style-wide-de}     
...
\hypersetup{
    pdftitle=Lebenslauf David Sinden,
    pdfauthor=David Sinden,
    pdfsubject={Lebenslauf, CV, Resume},
    colorlinks=false,
...
%
  \node[
    ...
    clip,
    inner sep=0
  ] at ([yshift=-0.5cm, xshift=1.5cm]current page.north west)  
    {\includegraphics[width=2.5cm]{../img/profile.png}};
  %
  \node[
    anchor=north west,
    xshift=4.8cm,                          % 2.5cm(photo)+0.5cm margin
    yshift=-1.88cm,
    text width=\dimexpr\paperwidth-3cm-2.5cm\relax, % leave 1cm right margin
    align=left,                        % or center or flush left/right as you like
    text=MidnightBlue,
    font=\thinfont
  ] at (current page.north west) {%
    home: \href{https://djps.github.io}{djps.github.io} 
%\quad
%    \href{https://x.com/david_sinden}{twitter: @david\_sinden} 
\quad
    \href{https://github.com/djps}{github:~djps} 
\quad
    \href{https://www.linkedin.com/in/sindendavid/}{linkedin:~sindendavid} \quad
    \href{https://www.xing.com/profile/David_Sinden}{xing:~david\_sinden} 
\quad
    (+49)~176~343~68520
\quad
    \href{mailto:david.sinden@gmail.com}{david.sinden@gmail.com} 
\quad
    Max-Planck-Strasse~43,~28357~Bremen, 
\quad \quad
    Britischer Staatsbürger mit ständigem Wohnsitz in Deutschland, 
\quad 
    geb:~27.12.1981
  };  
\end{tikzpicture}       
...
\entry
  ...
  {\jobtitle{Leitender Wissenschaftler — Modellierungs- und Simulationsgruppe\\
   \textnormal{Fähigkeiten: python, VTK, ITK, OpenCL, boost, eigen, jax,  Ultraschallmodellierung, Behandlungsplanung, Softwareentwicklung, Elastographie, Unsicherheitsanalyse}}%
...
\entry
  ...
  {\jobtitle{Postdoktoranden-Wissenschaftler — Therapeutische Ultraschallgruppe / Physik\\
   \textnormal{Fähigkeiten: Python, VTK, Ultraschallmodellierung, Behandlungsplanung, Softwareentwicklung}}%
   \begin{itemize}
...
\entry
  ...
  \text{\normalfont{Fähigkeiten: Mathematische Modellierung, Fortran, Differentialgleichungen} }}
  	\begin{itemize}
...
\section{Zusatzqualifikationen}\pdfbookmark[1]{Zusatzqualifikationen}{sec:skills}
  %\vspace{-0.2cm}
\begin{tabular}{p{0.64\textwidth} p{0.07\textwidth} p{0.35\textwidth} }
\textbf{Programming:} python, C++, Matlab, OpenCL & {} & \textbf{Libraries:} ITK, VTK, boost, eigen \\
%
\textbf{DevOps:} \hfill git, \hfill svn, \hfill github, \hfill gitlab, \hfill google~test, \hfill pytest, \hfill make, \hfill cmake, \hfill visual studio \hfill & {} & \textbf{Computation:} FEniCS, Comsol \\
%
