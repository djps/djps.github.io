...
\thispagestyle{fancy}
%
\recipient{ImFusion gGmbH}{Agnes-Pockels-Bogen 1\\80992 München\\ Germany}
%
\date{June 02 2025}
%
%\opening{}
...
I am applying for the position of Senior Research Scientist for Interventional Medical Imaging, having seen the position advertised in LinkedIn. I believe I would be a good technical fit for the role.
...
I am an applied mathematician by training, but have worked at the interface between academic research and industry for over ten years, in the United Kingdom and Germany, primarily in medical ultrasound but also in other clinical areas, such as ultra-low field MRI, pharmacokinetic modelling of function after liver surgery and lab-on-chip micro-fluidic devices. I have used the mathematical skills to write performant, well-documented, tested, deployable code in both python and C++, compliant with both ISO 13485 and IEC 62304. 
